...
- Figure IDs are settlement-scoped (`"<settlement>-<i>"`, `"born-<i>"`), unique within a settlement; global uniqueness relies on settlement names being unique.
