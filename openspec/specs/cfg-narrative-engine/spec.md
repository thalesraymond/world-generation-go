...
Define the Context-Free Grammar (CFG) narrative engine for translating numerical simulation events into rich, mythical text descriptions with variable injection and recursion protection.
